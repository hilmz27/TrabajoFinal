...
public class Frm_Login extends javax.swing.JFrame {
    public static String [][] ArrayUsuarios ={{"HMartinez","pass123"},{"MGuzman","pass123"},{"IAmpuero","pass456"},{"AZevallos","pass456"}  };
    ...
    public Image getIconImage() {
     ...
     public static boolean valida_usuario(String p_usuario, String p_password) {
       boolean lb_usuario_validado=false;
       for (int i=0; i<ArrayUsuarios.length; i++)
        {
            for (int j=0; j < ArrayUsuarios[i].length; j++) {
             
                if (p_usuario.toUpperCase().trim().equals(ArrayUsuarios[i][0].toUpperCase()) && p_password.equals(ArrayUsuarios[i][1]) )
                {
                    lb_usuario_validado=true;
                    break;
                }
                
            }
           if  (lb_usuario_validado) 
           {
               break;
           }
        }
        
       return lb_usuario_validado;
    }
    ...
    private void login(){
        ...
        lb_validado =valida_usuario(user.toUpperCase(),pass);
    ...
    private void initComponents() {
        ...
        setTitle("Sistema de Incidente ServiDesk");
